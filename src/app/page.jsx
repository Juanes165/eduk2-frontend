...
export default function Home() {
  return (
    <>
      <header className="flex items-center sticky top-0 justify-between pt-4 pb-2 border-b-2 mx-4 border-amethyst dark:border-grape lg:border-b-4 xl:p-5 xl:mx-8">
        <div className="flex gap-3 items-center">
          <img src="logoLight.png" className="block dark:hidden rounded-full mb-1 lg:w-16 xl:w-12" />
          <img src="logoDark.png" className="hidden dark:block rounded-full mb-1 lg:w-16 xl:w-12" />
