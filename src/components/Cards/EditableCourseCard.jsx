...
export default function EditableCourseCard({ course }) {
  ...
  return (
    <a href={`/course/${course.id}`} className="hover:scale-105 duration-200 transition-all flex flex-col w-full md:w-[300px] 2xl:w-[400px] border border-black border-opacity-15 hover:shadow-xl shadow-md shadow-gray-300 dark:shadow-none hover:cursor-pointer rounded-lg bg-main-light">
      <img
        src={courseImage}
        alt={course.name}
